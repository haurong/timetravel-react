...
export const SITE_IMG = `${MY_HOST}/uploads/site`;
...
export const ITINERARY_LISTNEW = `${MY_HOST}/itinerary/api/listnew`;
...
export const ITINERARY_ADDITEM = `${MY_HOST}/itinerary/api/additem`;
